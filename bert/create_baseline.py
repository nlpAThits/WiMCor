...
for line in inp:
    ...
    bert_right = bert_pad(cond_bert_emb[start.i + 1:][:seq_length], False)
    bert_left = bert_pad(cond_bert_emb[:index - len(entity) + 1][-seq_length:], True)
...
dump_to_hdf5("{}/bert_pickle/{}_base.hdf5".format(dirname, rawname), out)